...
import net.whiterm.claysoldiersrebornmissfeatures.network.packet.C2S.NexusSendWithdrawSoldiersCountC2SPacket;
...
public class ModPackets {
    ...
    public static final Identifier NEXUS_SEND_WITHDRAW_SOLDIERS_COUNT_ID = new Identifier(ClaySoldiersRebornMissfeatures.MOD_ID, "nexus_send_withdraw_soldiers_count");
    ...
    public static void registerC2SPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(NEXUS_SEND_WITHDRAW_SOLDIERS_COUNT_ID, NexusSendWithdrawSoldiersCountC2SPacket::receive);
    }
